...
homicide = raw_homicide %>%
  ...
  janitor::clean_names()
```
The raw homicide dataset consists of case information (uid, reported_date, disposition), geo information (city, state, lat, lon), and victim information (race, age, first and last name) of homocidal crimes on 50 large U.S. cities. The data is consist of `r nrow(homicide)` rows by `r ncol(homicide)` columns.
